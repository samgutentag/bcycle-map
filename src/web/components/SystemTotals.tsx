...
export default function SystemTotals({ stations, variant = 'overlay' }: Props) {
  ...
  const utilization = totals.bikes + totals.docks > 0
    ? Math.round((totals.bikes / (totals.bikes + totals.docks)) * 100)
    : 0
  ...
  return (
    <div className={`${wrapperClass} text-sm text-neutral-900`}>
      ...
      <div className="flex gap-5">
        ...
        <div>
          <div className="text-xl font-bold leading-tight">{totals.docks}</div>
